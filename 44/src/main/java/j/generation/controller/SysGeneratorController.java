package j.generation.controller;

import j.common.utils.PageUtils;
import j.common.utils.Query;
import j.generation.service.SysGeneratorService;
...
//	@RequestMapping("/code")
	...
	@GetMapping("/code")
	public ResponseEntity code(HttpServletRequest request, HttpServletResponse response) throws IOException{
